...
KR 판단은 오늘 한국장 자료 불러오기 → 오늘 종목 판단 준비하기(시장 분위기 확인·오늘 주가 채우기·종목 판단 미리보기 일괄 실행) → 전체 결과표와 후보 카드 → 종목 선택 → 선택 종목 상세·리스크·상세 입력 → 저장 전 확인 → 최종 저장 순서입니다. US는 오늘 미국장 자료 불러오기 → 기본 종목 불러오기 → 전체 결과표·상세 입력 선택 → 저장 전 확인 순서의 기존 스윙 구조를 유지합니다.
