...
#
# **2026-09-07 상하님 지시로 미국테마 하나만 남겼다** — "온라인은 미국테마,
# 즉 자비스3만 화면에 띄우고 전부 안 보이게 해라."
#
# 한국테마를 닫으면 미국테마 맨 위의 「🌏 한국테마 →」 단추가 막힌 화면으로 가는
# **죽은 단추**가 된다. 그래서 그 단추는 갈 곳이 닫혀 있으면 아예 안 그린다
# (method_help.cross_market_link). 이름을 여기 도로 넣으면 단추도 같이 살아난다.
OPEN_PAGES = ("미국테마",)
