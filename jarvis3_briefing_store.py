...
# (nth-child) 때문이고 저장 한도는 여섯이었다 — 둘 다 여덟로 맞췄다.
# 2026-09-12 상하님 지시로 8 → 10. "사용자 선정 종목 10개로 하고 추가 검색
# 종목은 20개로 해라." 기본 종목은 여섯이라 7~10번은 비어 있고, 빈 자리는
# 빈 채로 둔다(selected_stocks 가 이미 그렇게 돌려준다).
SELECTED_SLOTS = 10
# 기본 4종목을 실제 줄로 옮겨 적으면서 자리를 8에서 12로 늘렸다(2026-08-26).
# 2026-09-12 상하님 지시로 12 → 20.
EXTRA_LIMIT = 20
