...
_REQUIRED_J4_REVISION = 2026080790
if (
...
def _render_pullback_finder() -> None:
    ...
    with st.expander("눌림목 종목 찾기 설명 보기", expanded=False):
        ...
        st.markdown(
            ...
            " padding-left:.8rem'>"
            "<b class='j4-down'>⚠ 이 점수는 성적을 맞히지 못합니다</b> — 2026-08-07에 "
            "12년치(테마 2,272종목)를 3년 창으로 밀며 처음 재 봤습니다. "
            "<b>이동평균 위(60점)와 20일 상대강도(20점)는 거꾸로였습니다</b> — "
            "50일선 위인 종목이 107개 창 중 11개에서만 이겼고(0~11%), "
            "20일 수익률 상위도 0~10%였습니다. "
            "값을 한 것은 <b>신고가에 가까운가</b>(88·95·100%)와 "
            "<b>변동성 4% 미만</b>(86·73·77%) 둘뿐입니다.<br>"
            "이 화면은 ‘이걸 사라’가 아니라 <b>‘지금 사면 얼마나 위험한가’</b>를 "
            "재는 것입니다. <u>점수 순서를 매수 순서로 읽지 마십시오.</u> "
            "검증된 자리는 위 <b>상승장</b>·<b>급락 후 반등장</b> 두 단추에 있습니다.</div>",
            unsafe_allow_html=True,
        )
        st.markdown(
