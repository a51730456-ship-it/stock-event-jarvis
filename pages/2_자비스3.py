...
_REQUIRED_METHOD_HELP_REVISION = 2026080650
...
_SCORE_TABLE = {
    ...
    "crash": (
        ("같은 테마 동반", 40, "같은 테마에서 3종목 이상 같이 눌리면 만점입니다. "
                              "이 화면에서는 <u>뒤 5년만 이겼지만</u>(앞 5년엔 졌습니다), "
                              "테마가 같이 움직이는 정도가 해마다 커지고 있어 "
                              "1등에 뒀습니다 — 2026년이 10년 중 가장 강합니다"),
