...
_SCORE_TABLE = {
    ...
    "crash": (
        ("테마가 30주선 위에 있나", "above150",
         "그 테마 종목 중 몇 %가 <b>30주선(150일선) 위</b>인가, 그 등수입니다. "
         "<b>상위 3등에만</b> 점수를 줍니다 — 5등으로 넓히면 무너집니다.<br>"
         "<b>왜 30주선인가</b> — 바닥에서 <b>30주선 위로 올라설 때</b>가 오름세의 "
         "시작이라는 것이 Weinstein(1988)의 오래된 기준입니다. 급락 후 반등이 바로 "
         "그 자리입니다.<br>"
         "<b>제가 재 보니</b> — 나스닥이 −12%·−18%·−24%에 닿은 날과 그 저점 다음 날, "
         "<u>여섯 자리 모두</u>에서 상위 3등 테마의 종목이 나머지보다 앞섰습니다"
         "(가운데 +2.8 ~ +7.3%p · 반등 6개월은 <b>23번 중 20번</b>)"),
        ("테마가 덜 빠졌나", "less_drop",
         "<u>2026-08-14에 뺐습니다</u> — <b>자리에 따라 방향이 뒤집힙니다.</b> "
         "급락이 이어지는 동안에는 덜 빠진 테마가 낫고, 반등이 시작되면 반대로 "
         "기웁니다. 한 방향으로 못 정하는 값은 쓰지 않습니다"),
        ("테마 주봉이 오름세인가", "aligned",
         "<u>2026-08-14에 뺐습니다</u> — 종가가 50일선 위 · 50일선이 150일선 위 · "
         "150일선이 200일선 위 · 200일선이 오르는 중, 이 넷을 다 맞춰야 합니다. "
         "<b>상승이 한창일 때의 조건</b>이라 급락 직후에는 맞는 테마가 거의 없습니다. "
         "위 30주선 하나가 같은 것을 훨씬 잘 잡습니다"),
        ("테마가 20일선 위에 있나", "above20",
         "<u>2026-08-14에 점수에서 뺐습니다</u> — 점수에 넣으면 오히려 나빠집니다"
         "(30주선만 쓸 때 100번 중 88번 → 20일선을 섞으면 71번). "
         "대신 <b>같은 점수를 가르는 데</b> 씁니다"),
        ("테마가 같이 오르는가", "spread5",
...
_SCORE_TABLE_PLAIN = {
    ...
    "crash": ("<b>쉽게 말해</b> — <b>이미 30주선 위로 올라선</b> 테마를 위로 올립니다. "
              "바닥에서 30주선을 넘어서는 자리가 오름세의 시작이기 때문입니다.<br>"
              "<b>2026-08-14에 배점을 통째로 바꿨습니다.</b> 그전에는 ‘덜 떨어진 테마’에 "
              "40점을 줬는데, <u>상하님이 실제로 사시는 자리</u>(나스닥이 −12%·−18%·"
              "−24%에 닿았을 때)에서 다시 재 보니 <b>거꾸로였습니다.</b><br>"
              "<b>위 테마 순위표 점수는 상승장 기준입니다.</b> 급락 후 반등 자리에서는 "
              "순위표 위쪽을 그대로 고르시면 안 됩니다."),
}
