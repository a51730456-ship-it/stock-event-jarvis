...
_SCORE_TABLE = {
    ...
    "crash": (
        ("테마가 30주선 위에 있나", "above150",
         "<b>무엇을 보는가</b> — <b>앱은</b> 그 테마에 속한 회사들 중 <b>몇 %가 "
         "30주선 위에 있는지</b> 셉니다. 그리고 테마 20개를 그 비율로 줄 세워 "
         "<b>상위 3등</b>에만 점수를 줍니다.<br>"
         "<b>30주선이란</b> 최근 30주(약 150거래일) 평균값을 이어 그린 선입니다. "
         "주가가 그 위에 있으면 <u>반년 평균보다 지금이 비싸다</u>는 뜻입니다.<br>"
         "<b>왜 이것을 보는가</b> — <b>스탠 와인스타인은</b> 1988년에 주가가 바닥을 "
         "다지고 <b>30주선 위로 올라설 때가 오름세의 시작</b>이라고 했습니다. "
         "급락 후 반등이 바로 그 자리입니다.<br>"
         "<b>제가 재어 보니</b> — 나스닥이 −12%·−18%·−24%에 닿은 날과 그 뒤 바닥을 찍고 "
         "돌아선 날, <u>여섯 자리 모두</u>에서 상위 3등 테마의 종목이 나머지보다 "
         "더 벌었습니다(+2.8 ~ +7.3% · <b>돌아선 날 6개월은 23번 중 20번</b>).<br>"
         "<b>왜 3등까지만인가</b> — <b>제가</b> 5등까지 넓혀 보니 무너졌습니다"
         "(문턱에 닿은 날 3개월이 −3.2%로 거꾸로). 7등은 더 나빴습니다"),
        ("테마가 덜 빠졌나", "less_drop",
         "<u>2026-08-14에 뺐습니다.</u> <b>제가 잰 자리가 틀렸었습니다</b> — 저는 "
         "나스닥이 조금이라도 빠진 날을 <b>전부</b> 넣고 쟀는데, 그 대부분은 "
         "<b>아직 더 떨어지는 중인 날</b>이었습니다. 떨어지는 중에는 덜 빠진 테마가 "
         "덜 손해 보는 것이 당연합니다.<br>"
         "<b>상하님이 실제로 사시는 자리</b>(나스닥이 −12%·−18%·−24%에 닿았을 때)에서 "
         "다시 재니 <b>100번 중 36번</b>이었습니다 — 거꾸로였습니다"),
        ("테마 주봉이 오름세인가", "aligned",
         "<u>2026-08-14에 뺐습니다.</u> <b>앱이</b> 이 잣대로 보려면 종가가 50일선 위 · "
         "50일선이 150일선 위 · 150일선이 200일선 위 · 200일선까지 오르는 중, "
         "이 넷을 다 맞춰야 합니다. <b>상승이 한창일 때의 모습</b>입니다.<br>"
         "<b>급락 직후에는 그 조건을 맞추는 테마가 거의 없습니다</b> — 제가 재려 해도 "
         "잴 수 있는 사건이 한두 번뿐이었습니다. <b>위 30주선 하나가 훨씬 느슨해서 "
         "그 자리를 잡습니다</b>"),
        ("테마가 20일선 위에 있나", "above20",
         "<u>2026-08-14에 점수에서 뺐습니다.</u> <b>제가 30주선과 섞어 봤더니 "
         "오히려 나빠졌습니다</b> — 30주선만 쓰면 100번 중 88번인데, 20일선을 섞으면 "
         "<b>71번</b>으로 떨어집니다.<br>"
         "<b>그래서 앱은</b> 이것을 점수에 넣지 않고, <b>점수가 같을 때 순서를 가르는 "
         "데만</b> 씁니다"),
        ("테마가 같이 오르는가", "spread5",
...
_SCORE_TABLE_PLAIN = {
    ...
    "crash": ("<b>쉽게 말해</b> — <b>앱은</b> 크게 빠진 종목 중에서 <b>그 종목이 속한 "
              "테마가 이미 30주선을 넘어선</b> 것을 위로 올립니다. 바닥을 다지고 "
              "30주선을 넘어서는 자리가 <b>오름세의 시작</b>이기 때문입니다.<br>"
              "<b>앱의 만점은 40점입니다.</b> 만점이 곧 이 자리의 근거의 양입니다 — "
              "제가 잰 여러 잣대 중 <u>통과한 것이 이것 하나뿐</u>이라 40점입니다.<br>"
              "<b>2026-08-14에 제가 배점을 통째로 바꿨습니다.</b> 그전에는 ‘덜 떨어진 "
              "테마’에 40점을 줬는데, <u>상하님이 실제로 사시는 자리</u>(나스닥이 "
              "−12%·−18%·−24%에 닿았을 때)에서 다시 재 보니 <b>100번 중 36번</b>으로 "
              "거꾸로였습니다.<br>"
              "<b>위 테마 순위표 점수는 상승장 기준입니다.</b> 급락 후 반등 자리에서 "
              "제가 재 보니 100번 중 44~47번이었습니다 — <u>순위표 위쪽을 그대로 "
              "고르시면 안 됩니다.</u><br>"
              "<b>같은 점수는 테마를 번갈아 놓습니다.</b> 상위 3등 테마의 종목이 전부 "
              "같은 점수라, 회사가 많은 테마가 화면 위를 통째로 차지하기 때문입니다."),
}
