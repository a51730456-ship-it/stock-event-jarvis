...
# 설명을 만들어라. 클릭하면 설명이 나오고 다시 클릭하면 없어지도록. 신고가 눌림
# 전용 배점도, 급락 후 반등장도, 테마 실시간 종목선정 근거에도."
# 여닫는 방식은 '이 화면 설명 보기'와 **같은 장치**를 쓴다(_section_toggle +
# _section_close) — 위에서 열고 아래에서도 닫는다.
#
...
_FACTOR_HELP = (
    ("테마가 1년 최고에 붙어 있나",
     "<b>앱은 이 종목 하나가 아니라, 이 종목이 든 무리 전체를 봅니다.</b><br>"
     "앱은 그 테마에 든 회사들의 <b>몸값(시가총액)을 전부 더한 뒤</b>, 그 합계가 "
     "<b>지난 1년 동안 가장 컸을 때</b>의 몇 %인지 잽니다.<br>"
     "<b>100% → 70점</b>(무리가 지금 1년 중 가장 큽니다) · 95% → 52점 · "
     "90% → 35점 · 85% → 17점 · <b>80% 아래 → 0점</b><br>"
     "<b>왜 보는가</b> — 종목 하나가 혼자 오르면 그 하나가 지치면 끝입니다. "
     "무리가 함께 오르고 있으면 뒤에서 밀어 주는 힘이 남아 있습니다.<br>"
     "<b>이렇게 읽으십시오</b> — 이 종목은 고점에서 눌렸는데 무리는 1년 최고에 붙어 "
     "있다면, <b>무리는 멀쩡한데 이 종목만 잠깐 쉬는 자리</b>입니다. 거꾸로 무리가 "
     "식는 중에 이 종목만 튀었다면 혼자 튄 것입니다.<br>"
     "<b>헷갈리기 쉬운 것</b> — 오른쪽 「테마 상황」의 <b>테마 자체 점수 ○○/100</b>과는 "
     "<b>다른 숫자</b>입니다. 그건 테마 20개를 여러 잣대로 줄 세운 점수이고, "
     "여기 %는 <b>몸값이 1년 최고에 얼마나 가까운가</b> 하나만 본 값입니다."),
    ("뚫기 전 60일에 얼마나 올랐나",
     "앱은 이 종목이 <b>1년 최고가를 뚫던 날</b>에 서서, 그 <b>앞 60거래일"
     "(약 석 달)</b> 동안 몇 % 올랐는지 봅니다. <b>오늘 기준이 아닙니다</b> — "
     "뚫고 나서 눌린 만큼 깎이면 그 힘이 가려집니다.<br>"
     "75% 이상 30점 · 50~75% 19점 · 35~50% 15점 · 20~35% 11점 · 20% 미만 4점<br>"
     "<b>왜 보는가</b> — 석 달에 크게 오르려면 까닭이 있고, 그 까닭은 하루아침에 "
     "사라지지 않습니다.<br>"
     "<b>짚어 둘 것</b> — 많이 오른 쪽이 <b>더 자주</b> 이기지는 않습니다"
     "(100번 중 61번 → 69번). 대신 <b>이길 때 크게 법니다</b>(+8% → +43%)."),
    ("테마가 덜 빠졌나",
     "앱은 급락장에서 그 테마가 다른 테마보다 <b>덜 떨어졌는지</b> 봅니다. "
     "앱은 테마 20개를 줄 세워 <b>위쪽 몇 등</b> 안에 들면 점수를 줍니다.<br>"
     "<b>왜 보는가</b> — 다 떨어지는 날에도 덜 떨어지는 무리가 있고, 되돌아올 때 "
     "그 무리가 먼저 올라옵니다.<br>"
     "급락 갈래에서 <b>보유 3개월·6개월·1년 셋 다 통과한 유일한 항목</b>입니다."),
    ("테마 주봉이 오름세인가",
     "앱은 그 테마 회사들 중 몇 %가 <b>아직 오름세 모양</b>인지 봅니다. "
     "오름세 모양이란 <b>지금 값이 50일 평균 위 · 50일 평균이 150일 평균 위 · "
     "150일 평균이 200일 평균 위</b>이고 <b>200일 평균이 오르는 중</b>인 것입니다.<br>"
     "<b>왜 보는가</b> — 급락장에는 하루 반짝 오르는 일이 흔합니다. 이 잣대는 그 "
     "반짝을 걸러냅니다. 이걸로 고른 종목은 <b>20% 오르는 데 34일</b> 걸렸고, "
     "아무거나 산 것은 <b>45일</b> 걸렸습니다."),
    ("테마가 20일선 위에 있나",
     "앱은 그 테마 회사들 중 몇 %가 <b>최근 한 달 평균값 위</b>에 있는지 봅니다. "
     "무리가 <b>이미 돌아서기 시작했는지</b> 보는 잣대입니다."),
    ("테마 대비 상대강도",
     "앱은 이 종목이 최근 20일 동안 <b>자기 테마 평균보다 더 올랐는지</b> 봅니다. "
     "같은 무리 안에서 <b>앞서가는 종목인지</b> 보는 것입니다."),
    ("SPY 대비 상대강도",
     "앱은 이 종목이 최근 20일 동안 <b>미국 시장 전체(SPY)보다 더 올랐는지</b> "
     "봅니다. 이 자리는 견줄 테마가 없어 시장 전체와 견줍니다."),
    ("52주 신고가 위치",
     "앱은 지금 값이 <b>지난 1년 최고가에 얼마나 가까운지</b> 봅니다. "
     "가까울수록 점수가 높습니다."),
    ("추세",
     "앱은 <b>짧은 평균선이 긴 평균선 위에</b> 있는지 봅니다(20일 · 50일 · 200일). "
     "위에서부터 차례로 놓여 있으면 오르는 중입니다."),
    ("유동성",
     "앱은 이 종목이 하루에 <b>얼마나 많이 사고팔리는지</b> 봅니다. 적으면 상하님이 "
     "사고팔 때 값이 크게 흔들립니다. <b>성적을 맞히는 잣대가 아니라 「살 수 있는 "
     "종목인가」를 보는 잣대</b>입니다."),
    ("변동성 안정",
     "앱은 값이 하루에 <b>얼마나 크게 흔들리는지</b> 봅니다. 이것도 성적이 아니라 "
     "<b>「상하님이 감당하실 크기인가」를 보는 잣대</b>입니다."),
)
...
def _factor_help_block(names, key: str) -> None:
    ...
    if not picked:
        return
    if not _section_toggle(
        "📗 심사항목 기준 — 이 말이 무슨 뜻인가", key,
        close_label="심사항목 기준 닫기",
    ):
        return
    st.markdown(
        "".join(
            "<div style='border-left:3px solid #6ee7b7; background:rgba(110,231,183,.06);"
            " padding:.6rem .8rem; margin:.5rem 0; border-radius:6px'>"
            f"<div style='font-weight:800; color:#6ee7b7; margin-bottom:.35rem'>{html.escape(name)}</div>"
            f"<div style='line-height:1.65; font-size:.92rem'>{body}</div></div>"
            for name, body in picked
        ),
        unsafe_allow_html=True,
    )
    _section_close(key, "심사항목 기준 닫기")
