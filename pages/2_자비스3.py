...
_REQUIRED_SIGNAL_UI_REVISION = 2026080610
if (
...
_SCORE_TABLE = {
    ...
    "crash": (
        ("최근 11일에 빠졌나", 40, "이 화면에서 앞 5년·뒤 5년을 <b>둘 다</b> 이긴 "
                                  "<u>유일한</u> 값입니다. 낙폭과 <u>다른 것</u>을 잽니다 — "
                                  "낙폭은 구덩이가 얼마나 깊은가이고, 이것은 방금 빠졌나 "
                                  "이미 올라왔나입니다"),
        ("같은 테마 동반", 25, "같은 테마에서 3종목 이상 같이 눌리면 만점입니다. 다만 "
                              "<u>뒤 5년만 이겼습니다</u>(앞 5년엔 졌습니다). "
                              "상승장 화면에서는 이 값이 가장 세지만 여기서는 아닙니다"),
